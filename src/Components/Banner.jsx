  ...
  return (
    <div className="my-20 mx-10 lg:mx-40">
      <div className="flex items-center flex-wrap">
        <div className="lg:w-28"></div><iframe
          src={vid}
          frameBorder="0"
          ...
          scrolling="no"
        ></iframe>
        <h1 className="uppercase text-4xl md:text-6xl lg:text-8xl font-bold font-inter text-[#00CCF8]">
          Carpet
        </h1>
      </div>
      ...
      <div className="py-10 flex items-center flex-col md:flex-row justify-center text-center gap-10">
        <div>
          <h4 className="">
        ...
        <div className="relative">
          <img
            src={call}
            alt="call"
            className="bg-[#00CCF8] p-8 md:p-4 lg:p-6 rounded-full absolute top-8 left-9 md:top-4 lg:top-10 md:left-4 lg:left-10"
          />
